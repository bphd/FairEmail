...
public abstract class DB extends RoomDatabase {
                ...
                .addCallback(new Callback() {
                    ...
                    public void onOpen(@NonNull SupportSQLiteDatabase db) {
                        ...
                        if (cache_size != null) {
                            ...
                            try (Cursor cursor = DB.jni_db_query(db, "PRAGMA cache_size=" + cache_size + ";")) {
                                cursor.moveToNext(); // required
                            }
                        }
                        ...
                        for (String pragma : DB_PRAGMAS)
                            if (!"compile_options".equals(pragma) || BuildConfig.DEBUG)
                                try (Cursor cursor = DB.jni_db_query(db, "PRAGMA " + pragma + ";")) {
                                    boolean has = false;
                                    while (cursor.moveToNext()) {
                                        has = true;
    ...
    private static void createTriggers(@NonNull SupportSQLiteDatabase db) {
        ...
        DB.jni_db_exec(db, "CREATE TRIGGER IF NOT EXISTS attachment_insert" +
                ...
                " END");
        DB.jni_db_exec(db, "CREATE TRIGGER IF NOT EXISTS attachment_delete" +
